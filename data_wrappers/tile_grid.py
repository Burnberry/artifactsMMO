...
class Grid:
    ...
    # events
    demon = TileContent(tile_content_data['demon'])
    bandit_lizard = TileContent(tile_content_data['bandit_lizard'])
    cultist_emperor = TileContent(tile_content_data['cultist_emperor'])
    strange_rocks = TileContent(tile_content_data['strange_rocks'])
    magic_tree = TileContent(tile_content_data['magic_tree'])
    rosenblood = TileContent(tile_content_data['rosenblood'])
    efreet_sultan = TileContent(tile_content_data['efreet_sultan'])
    cursed_tree = TileContent(tile_content_data['cursed_tree'])
    fish_merchant = TileContent(tile_content_data['fish_merchant'])
    timber_merchant = TileContent(tile_content_data['timber_merchant'])
    herbal_merchant = TileContent(tile_content_data['herbal_merchant'])
    nomadic_merchant = TileContent(tile_content_data['nomadic_merchant'])
    gemstone_merchant = TileContent(tile_content_data['gemstone_merchant'])
